...
const registration = {
  guestName: "Musodiq Aderibigbe",
  guestEmail: null,
  guestChandaNumber: null
};

function testCsvValidation() {
  console.log("Testing CSV validation logic...");
  
  const csvValidationPassed = memberData.some((member) => {
  ...
  console.log("CSV validation result:", csvValidationPassed);
  return csvValidationPassed;
}
