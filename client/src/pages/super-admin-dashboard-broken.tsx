...
export default function SuperAdminDashboard() {
  ...
  // Fetch organization-specific analytics when an organization is selected
      ...
      <Tabs defaultValue="users" className="space-y-6">
        ...
        <div className="w-full overflow-x-auto">
          <TabsList className="grid grid-cols-5 lg:grid-cols-8 gap-1 h-auto min-w-max lg:min-w-full">
            ...
            <TabsTrigger value="org-analytics" className="flex flex-col items-center gap-1 py-3 text-xs">
              <BarChart3 className="w-4 h-4" />
              <span className="hidden sm:inline text-xs">Org Analytics</span>
              <span className="sm:hidden text-xs">Org Stats</span>
            </TabsTrigger>
          </TabsList>
        </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {organizationsData?.organizations?.map((org) => (
                    <Card key={org.id} className="cursor-pointer hover:bg-muted/50 transition-colors border-2 hover:border-primary/20"
